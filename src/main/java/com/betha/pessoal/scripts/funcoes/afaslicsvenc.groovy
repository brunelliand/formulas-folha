...
import static com.betha.pessoal.scripts.padrao.enums.ClassificacaoTipoAfastamento
import static com.betha.pessoal.scripts.padrao.enums.UnidadePagamento;

class Afaslicsvenc {
    public static long getAfaslicsvenc() {
        /** Dentro deste bloco deverá esta o conteúdo do script, o mesmo do cadastro de funções para fórmulas **/
        def dias = 0

        def classificacoes = ClassificacaoTipoAfastamento.LICENCA_SEM_VENCIMENTOS
