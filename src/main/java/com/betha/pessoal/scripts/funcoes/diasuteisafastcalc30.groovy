...
class Diasuteisafastcalc30 {
    static Integer getDiasuteisafastcalc30(Date competencia, def sabadoUtil, List<ClassificacaoTipoAfastamento> classificacaoAfastamentos) {
