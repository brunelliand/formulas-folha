...
def evento = [codigo: 108, taxa: 0, tipo: TipoEvento.VENCIMENTO, unidade: UnidadeEvento.AUTOMATICO]; //Configuracao do evento
...
if (vvar> 0){
    ...
    def base = Eventos.valor(109) + Eventos.valor(110)+ Eventos.valor(237)
