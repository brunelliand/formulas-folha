...
def evento = [codigo: 16, taxa: 1, tipo: TipoEvento.VENCIMENTO, unidade: UnidadeEvento.AUTOMATICO];
...
if (TipoMatricula.FUNCIONARIO.equals(matricula.tipo)) {
    ...
    if (vcal > 0) {
        ...
        dias = Funcoes.diastrab() + Funcoes.diasafastcalc30(calculo.competencia, afastamentos)
