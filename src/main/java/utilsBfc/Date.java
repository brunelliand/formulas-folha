...
//                (BaseCalendar.Date) cal.getCalendarDate(getTime());
...
//        int zoneOffset;
//        if (cdate == null) {
//            java.util.TimeZone tz = TimeZone.getDefaultRef();
...
//    private final BaseCalendar.Date normalize(@NotNull BaseCalendar.Date date) {
...
//    @NotNull
//    @Contract("_ -> new")
//    static java.util.Date DateBfcToDate(@NotNull Date data) {
//        return new java.util.Date(data.getYear(), data.getMonth(), data.getDayOfMonth());
//    }
//
////    private static DateBfc DateToDateBfc(@NotNull Date data) {
////        return Datas.data(data.getYear(), data.getMonth(), data.getDate());
////    }
//
////    private static DateBfc getRemoveDias(int dias) {
////        Date date = new Date();
////        Calendar c = Calendar.getInstance();
////        c.setTime(date);
////        c.add(Calendar.DATE, dias);
////        date = c.getTime();
////        return DateToDateBfc(date);
////    }
//
////    static DateBfc removeDias(int dias) {
////        return getRemoveDias(dias);
////    }
//
//
//
