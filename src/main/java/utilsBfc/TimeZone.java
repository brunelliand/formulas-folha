...
abstract public class TimeZone implements Serializable, Cloneable {
     ...
     * @since 1.8
     */
    public static java.util.TimeZone getTimeZone(ZoneId zoneId) {
    ...
    private static java.util.TimeZone getTimeZone(String ID, boolean fallback) {
    ...
    static java.util.TimeZone getDefaultRef() {
        java.util.TimeZone defaultZone = defaultTimeZone;
        if (defaultZone == null) {
     ...
     */
    private static final java.util.TimeZone parseCustomTimeZone(String id) {
        int length;
